...
function getCommands()
{
  ...
  slashCommand.addSubcommand(subcommand => subcommand
    ...
    .addIntegerOption(option =>
      ...
      .setDescription("The total bashing damage inflicted. WtA 20th Corebook p255")
      .setMinValue(0)
      .setMaxValue(15)
    )
    ...
    .addIntegerOption(option =>
      ...
      .setDescription("The total lethal damage inflicted. WtA 20th Corebook p255")
      .setMinValue(0)
      .setMaxValue(15)
    )
    ...
    .addIntegerOption(option =>
      ...
      .setDescription("The total Agg damage inflicted. WtA 20th Corebook p255")
      .setMinValue(0)
      .setMaxValue(15)
    )
