...
/////////////////////////////// New Ghoul ////////////////////////////////
  ...
  slashCommand.addSubcommand(subcommand => subcommand
    ...
    .addIntegerOption(option =>
      option.setName("humanity")
      .setDescription("Sets your humanity to the number. " +
        "Must be between 0 and 10. VtM 20th Corebook p309")
      .setMinValue(0)
      .setMaxValue(10)
    )
    ...
    .addIntegerOption(option =>
      option.setName("bashing_damage")
      .setDescription("The total bashing damage inflicted. VtM 20th Corebook p285")
      .setMinValue(0)
      .setMaxValue(15)
    )
    ...
    .addIntegerOption(option =>
      option.setName("lethal_damage")
      .setDescription("The total lethal damage inflicted. VtM 20th Corebook p285")
      .setMinValue(0)
      .setMaxValue(15)
    )
    ...
    .addIntegerOption(option =>
      option.setName("agg_damage")
      .setDescription("The total Agg damage inflicted. VtM 20th Corebook p285")
      .setMinValue(0)
      .setMaxValue(15)
    )
