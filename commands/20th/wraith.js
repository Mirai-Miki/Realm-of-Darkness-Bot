...
function getCommands()
{
  ...
  slashCommand.addSubcommand(subcommand => subcommand
    ...
    .addIntegerOption(option =>
      ...
      .setDescription("The total bashing damage inflicted. WtO 20th Corebook p293")
      .setMinValue(0)
      .setMaxValue(15)
    )
    ...
    .addIntegerOption(option =>
      ...
      .setDescription("The total lethal damage inflicted. WtO 20th Corebook p294")
      .setMinValue(0)
      .setMaxValue(15)
    )
    ...
    .addIntegerOption(option =>
      ...
      .setDescription("The total Agg damage inflicted. WtO 20th Corebook p294")
      .setMinValue(0)
      .setMaxValue(15)
    )
