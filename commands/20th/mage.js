  ...
  slashCommand.addSubcommand(subcommand => subcommand
    ...
    .addIntegerOption(option =>
      option.setName("bashing_damage")
        .setDescription("The total bashing damage inflicted. MtA 20th Corebook p406")
        .setMinValue(0)
        .setMaxValue(15)
    )
    ...
    .addIntegerOption(option =>
      option.setName("lethal_damage")
        .setDescription("The total lethal damage inflicted. MtA 20th Corebook p407")
        .setMinValue(0)
        .setMaxValue(15)
    )
    ...
    .addIntegerOption(option =>
      option.setName("agg_damage")
        .setDescription("The total Agg damage inflicted. MtA 20th Corebook p407")
        .setMinValue(0)
        .setMaxValue(15)
    )
