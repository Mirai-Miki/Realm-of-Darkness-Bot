...
function getCommands()
{
  const slashCommand = new SlashCommandBuilder()
    ...
    .addIntegerOption(option =>
      ...
      .setDescription("The total bashing damage inflicted. CtD 20th Corebook p290")
      .setMinValue(0)
      .setMaxValue(15)
    )
    ...
    .addIntegerOption(option =>
      ...
      .setDescription("The total lethal damage inflicted. CtD 20th Corebook p290")
      .setMinValue(0)
      .setMaxValue(15)
    )
    ...
    .addIntegerOption(option =>
      ...
      .setDescription("The total Agg damage inflicted. CtD 20th Corebook p290")
      .setMinValue(0)
      .setMaxValue(15)
    )
