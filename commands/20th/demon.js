...
function getCommands()
{
  ...
  slashCommand.addSubcommand(subcommand => subcommand
    ...
    .addIntegerOption(option =>
      ...
      .setDescription("The total bashing damage inflicted. DtF Corebook p247")
      .setMinValue(0)
      .setMaxValue(15)
    )
    ...
    .addIntegerOption(option =>
      ...
      .setDescription("The total lethal damage inflicted. DtF Corebook p247")
      .setMinValue(0)
      .setMaxValue(15)
    )
  ...
  slashCommand.addSubcommand(subcommand => subcommand
    ...
    .addIntegerOption(option =>
      option.setName("bashing_damage")
      .setDescription("Updates your Bashing damage by the amount. DtF Corebook p247")
      .setMinValue(-50)
      .setMaxValue(50)
    )
    ...
    .addIntegerOption(option =>
      option.setName("lethal_damage")
      .setDescription("Updates your Lethal damage by the amount. DtF Corebook p247")
      .setMinValue(-50)
      .setMaxValue(50)
    )
    ...
    .addIntegerOption(option =>
      option.setName("agg_damage")
      .setDescription("Updates your Agg damage by the amount. DtF Corebook p247")
      .setMinValue(-50)
      .setMaxValue(50)
    )
